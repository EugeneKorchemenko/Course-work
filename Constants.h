...
const string ENTER_LOGIN = "Enter login: ";
...
const string ENTER_SURNAME = "Enter surname of employee: ";
...
const string ADD_PROJECTS = "Enter how many projects do you want to add (enter 0 to come back): ";
const string ENTER_NAME_OF_PROJECT = "Enter name of the project: ";
